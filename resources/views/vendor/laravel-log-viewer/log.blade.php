...
@section('content')
    <div class="wrap-fluid">
        ...
        <ul id="breadcrumb" style="margin-top: 20px;margin-bottom: 20px;border-left: 5px solid #ff9a81;">
            ...
            <li><a href="#" title="Sample page 1">日志文件</a>
            </li>

                @foreach($files as $file)
                    <li>
                    <a href="?l={{ base64_encode($file) }}" style="text-decoration:underline ">
                        {{$file}}
                    </a>
                    </li>
                @endforeach
          ...
          <div class="body-nest col-md-12">
              ...
              <div>
                  @if($current_file)
                      ...
                      @if(count($files) > 1)
                          -
                          <a id="delete-all-log" href="?delall=true"><span class="glyphicon glyphicon-trash"></span> 删除全部日志</a>
                      @endif
                  @endif
              </div>
          </div>
