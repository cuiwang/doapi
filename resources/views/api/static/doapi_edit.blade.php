...
@section('stylesheet')
    ...
    <div class="wrap-fluid">
        ...
        <ul id="breadcrumb" style="margin-top: 20px;border-left: 5px solid #0DB8DF;">
            ...
            <li><a href="#" title="Sample page 1">新建接口</a>
            </li>
        </ul>
        <!-- END OF BREADCRUMB -->
                                    ...
                                    <div class="timeline-body">
                                        <div class="well">
                                            ...
                                            <textarea id="json_content" rows="15"
                                                      ...
                                                      placeholder="请填入正确的json内容..">{{$api->json}}</textarea>
                                    </div>
                                    <div class='timeline-footer'>
    ...
    <!-- /MAIN EFFECT -->
    <script type="text/javascript" src="{{asset('assets/js/doapi_edit_main.js')}}"></script>
    <!-- GAGE -->
                        ...
                        if (!data.success) {
                            ...
                            layer.open({
                                ...
                                yes: function (index, layero) {
                                    ...
                                    window.location.href = '{{url('i'.'/'.$url.'/create#first')}}';
                                },
                                btn2: function (index, layero) {
                                    //do something
                                    window.location.href = "{{url('i/').'/'.$url.'/total#'}}";
                                }
                            });
                        }
                    },
