                        ...
                        <ul class="timeline">
                            ...
                            <li>
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-body">
                                        <div class="well">
                                            <h5>请填写请求地址和说明 . 只接受字母,数字,下划线,点,和<span
                            ...
                            <li>
                                ...
                                <div class="timeline-item">
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        <button style="width: 150px;height: 50px;border-radius:0;border-bottom: 1px solid #ddd;"
                                                                class="btn dropdown-toggle" type="button" id="back_type"
                                                                data-toggle="dropdown">
                                                            String 字符串类型
                                    ...
                                    <div class="timeline-footer" style="margin-top: 40px">
                                        <a class="btn btn-info btn-flat btn-xs" id="add_new_tr"
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (!data.success) {
                            ...
                            //创建成功啦
                            window.parent.changeNumFromIframe('dynamic_count','add')
...
//                $("html,body").animate({scrollTop:$("#first").offset().top},1000)
        ...
        function type_change(obj, method) {
            ...
            var target_td = btn_tr.cells[2].firstElementChild;
