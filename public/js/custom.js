...
//动画
		...
		setTimeout(function () { 
			//$('.sm1').style.display='inline';//显示,参数说明同上
			document.getElementById("tm-home-title").style.display='inherit';//显示,参数说明同上
			document.getElementById("tm-home-subtitle").style.display='inherit';//显示,参数说明同上
			document.getElementById("sm1").style.display='inherit';//显示,参数说明同上
			//$('.tm-home-subtitle').style.display='inline';//显示,参数说明同上();
			//$('.tm-home-title').style.display='inline';//显示,参数说明同上();

       $('.sm1').addClass('animated fadeInUpBig');
    $('.tm-home-subtitle').addClass('animated fadeInRightBig');
    setTimeout(function(){
		document.getElementById("kaishi").style.display='inline-block';//显示,参数说明同上
		//$('.kaishi').style.display='inline';//显示,参数说明同上
